...
namespace CursoCSharp.EstruturasDeControle {
    class EstruturaIf {
        public static void Executar() {
            ...
            bomComportamento = entrada.ToLower() == "s";        // passa o S to lower se for digitado maiúsculo. Compara c/ minúsculo para atribuir true. Se for diferente, fica o false definido anteriormente
