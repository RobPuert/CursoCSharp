...
namespace CursoCSharp.Fundamentos {
    class NotacaoPonto {
        public static void Executar() {
            ...
            Console.WriteLine(valorImportante?.Length);   // Mas podemos usar a navegação segura (a interrogação depois do nome da variável). Assim se for um valor null, ela                                               imprimi um espaço em branco apenas.
        }
    }
}
