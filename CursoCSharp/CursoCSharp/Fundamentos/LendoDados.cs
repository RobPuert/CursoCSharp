...
namespace CursoCSharp.Fundamentos
{
    class LendoDados {
        public static void Executar() {
            ...
            int idade = int.Parse(Console.ReadLine());      //por padrão o ReadLine só recebe string. Então precisamos do int.Parse para transformar em int e armazenar na variável int que definimos.
